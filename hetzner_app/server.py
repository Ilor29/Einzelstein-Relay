...
def _standardname(ordner: Path) -> str:
    """Name für eine Karte ohne eingetippten Titel: der Ordnername.

    Roli musste bei jeder neuen Karte einen Titel tippen (Rückmeldung
...
async def create_session(body: NewSession) -> dict:
    ...
    name = _sicherer_sitzungsname(body.name) or _standardname(cwd)
